...
#define MCP_8MHz_95k238BPS_CFG1 (0x01)   /* Increased SJW       */
#define MCP_8MHz_95k238BPS_CFG2 (0xBB)   /* Enabled SAM bit     */
#define MCP_8MHz_95k238BPS_CFG3 (0x07)   /* Sample point at 75% */
